...
const EditCourse = () => {
      ...
      await Promise.all(
        lessons.map(async (lesson) => {
          ...
          if (lesson.videoURL instanceof File) {
            const fileRef = ref(storage, `lessons/${lesson.lessonId}`);
  ...
  const isFormValid = () => {
    if (!course || !course.title || !course.description || !course.finalProject || !course.answer) {
      return false;
    }
            ...
            <>
              ...
              {lessons.map((lesson, index) => (
                ...
                >
                  ...
                  />
                  {lesson.videoURL && !(lesson.videoURL instanceof File) && (
                    <div>
                      <label>
                        Current Video:{" "}
                        <a
